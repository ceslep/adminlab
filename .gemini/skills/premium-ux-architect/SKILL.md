...
description: Arquitecto Senior especializado en UX/UI premium con implementación de Glassmorphism, Pixel Perfect Design, Motion Design y componentes enterprise al nivel de Stripe/Linear/Vercel.
---
