<script lang="ts">
  ...
  import pacientesImage from "../../../pacientes.png";
  import examenesImage from "../../../examenes.png";
  import reportesImage from "../../../reportes.png";
      ...
      >
        <div class="flex flex-col lg:flex-row items-center justify-between">
          <div class="flex-1 text-center lg:text-left mb-6 lg:mb-0">
            ...
            >
              ...
              <div>
                ...
                <h1
                  class="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-slate-900 via-indigo-900 to-purple-900 bg-clip-text text-transparent"
                >
                  AdminLab
                </h1>
              </div>
            ...
            <h1
              class="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-slate-900 via-indigo-900 to-purple-900 bg-clip-text text-transparent mb-4"
            >
              Bienvenido de nuevo
            </h1>
            <p class="text-lg text-slate-600 max-w-2xl">
              Gestiona tu laboratorio clínico con la plataforma más avanzada del
              mercado
            </p>
          </div>
          <div class="flex-1 flex justify-center">
            <div class="relative">
              <div
                class="absolute inset-0 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl blur-3xl opacity-20"
              ></div>
              <div
                class="relative bg-white/70 backdrop-blur-xl rounded-3xl p-8 border border-white/20"
              >
      ...
      <div class="bento-grid">
        ...
        >
          <div class="relative h-full flex flex-col overflow-hidden">
            ...
            <div
              class="absolute inset-0 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50"
            >
<img
                 src={pacientesImage}
                 alt="Pacientes"
                 ...
                 on:error={(e) =>
                   console.log("Error loading pacientes image:", e)}
                 on:load={() =>
                   console.log("Pacientes image loaded successfully")}
               />
              <!-- Additional gradient for depth -->
              <div
                class="absolute inset-0 bg-gradient-to-br from-transparent via-indigo-100/10 to-purple-100/10"
              ></div>
            </div>

            <!-- Content Overlay with glassmorphism -->
            <div
              class="absolute inset-0 bg-gradient-to-t from-white/85 via-white/50 to-transparent"
            ></div>

            <div class="absolute top-4 right-4">
              <div
                class="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl p-3 shadow-lg group-hover:scale-110 transition-transform duration-300"
              >
            ...
            <div class="flex-1 flex flex-col justify-end p-6 relative z-20">
              ...
              <p class="text-slate-600 mb-4">
                Gestión completa de pacientes y sus datos médicos
              </p>
              <div
        ...
        >
          <div class="relative h-full flex flex-col overflow-hidden">
            <!-- Background Image with gradient overlay -->
            <div
              class="absolute inset-0 bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50"
            >
<img
                 src={examenesImage}
                 alt="Exámenes"
                 class="absolute inset-0 w-full h-full object-cover opacity-60 transition-all duration-700"
                 on:error={(e) =>
                   console.log("Error loading examenes image:", e)}
                 on:load={() =>
                   console.log("Examenes image loaded successfully")}
               />
              <!-- Additional gradient for depth -->
              <div
                class="absolute inset-0 bg-gradient-to-br from-transparent via-emerald-100/10 to-green-100/10"
              ></div>
            </div>
            ...
            <div class="absolute top-4 right-4">
              <div
                class="bg-gradient-to-br from-emerald-500 to-green-600 rounded-2xl p-3 shadow-lg"
              >
        ...
        >
          <div class="relative h-full flex flex-col overflow-hidden">
            <!-- Background Image with gradient overlay -->
            <div
              class="absolute inset-0 bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50"
            >
<img
                 src={reportesImage}
                 alt="Reportes"
                 class="absolute inset-0 w-full h-full object-cover opacity-60 transition-all duration-700"
                 on:error={(e) =>
                   console.log("Error loading reportes image:", e)}
                 on:load={() =>
                   console.log("Reportes image loaded successfully")}
               />
              <!-- Additional gradient for depth -->
              <div
                class="absolute inset-0 bg-gradient-to-br from-transparent via-amber-100/10 to-orange-100/10"
              ></div>
            </div>
            ...
            <div class="absolute top-4 right-4">
              <div
                class="bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl p-3 shadow-lg"
              >
        ...
        >
          <div class="flex items-center justify-between">
            ...
            <div
              class="bg-gradient-to-br from-cyan-500 to-blue-600 rounded-xl p-2"
            >
        ...
        >
          <div class="flex items-center justify-between">
            ...
            <div
              class="bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl p-2"
            >
        ...
        >
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
              <div
                class="bg-gradient-to-br from-pink-500 to-rose-600 rounded-2xl p-4"
              >
                <Heart class="w-8 h-8 text-white" />
              </div>
              <div>
